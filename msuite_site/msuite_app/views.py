...
def landing(request):
	...
	return render(request, 'msuite_app/landing_basic.html', c)
...
def developers(request):
	...
	return render(request, 'msuite_app/developers_basic.html', c)
...
def projDetails(request, proj_id):
	...
	return render(request, 'msuite_app/projDetails_basic.html', c)
